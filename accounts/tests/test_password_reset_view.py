...
class SuccessfulPasswordResetTests(TestCase):
    def setUp(self):
        email = 'john@doe.com'
        User.objects.create_user(username='john', first_name="momo", last_name="Johnson", email=email, password='123abcdef')
        url = reverse('accounts:password_reset')
...
class PasswordResetConfirmTests(TestCase):
    def setUp(self):
        user = User.objects.create_user(username='john', first_name="James", last_name="Brown", email='john@doe.com', password='123abcdef')
